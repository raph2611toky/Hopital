...
- **Places** :
  ...
  - **P2 : Patients admis** (capacité 4, 0 jeton initial) : Représente les patients en cours de traitement, limitée à 3 pour simuler une capacité d'accueil.
  - **P3 : Lits disponibles** (4 jetons initiaux, capacité 4) : Représente les lits libres dans l'hôpital.
  ...
  - **P6 : Urgences** (0 jeton initial, capacité illimité).
...
- **Transitions** :
  ...
  - **T4 : Admission d'urgences** : qui déplace 1 jeton de P6 à P2 (Patients admis) si 1 jeton est disponible dans P3 (Lits disponibles).
...
- **Arcs entrants et sortants** :
  ...
  - **P6 → T4** : Poids = 1, Direction = BAS.
  - **P3 → T4** : Poids = 1, Direction = BAS.
  - **T4 → P2** : Poids = 1, Direction = HAUT.
  - **P6 → T1** : Poids = 1, Type = Inhibiteur, Direction = BAS.
